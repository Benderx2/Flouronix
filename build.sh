...
# Link it
i686-elf-ld -T ./arch/x86/boot/multiboot/hhlink.ld -o kernel.bin boot.o kernel.o VGA.o x86.o VGA_CON.o interrupt.o idt.o irq.o irq_c.o ps2.o kheap.o exceptions.o VFS.o ramfs.o mboot.o pit0.o paging.o libk.a
